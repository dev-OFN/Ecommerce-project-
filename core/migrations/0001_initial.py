    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_status', models.CharField(choices=[('draft', 'Draft'), ('disabled', 'Disabled'), ('rejected', 'Rejected'), ('in_review', 'in_Review'), ('published', 'Published')], default='In review', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.CharField(default='+123 (457) 986', max_length=100)),
                ('caht_resp_time', models.CharField(default='100', max_length=100)),
